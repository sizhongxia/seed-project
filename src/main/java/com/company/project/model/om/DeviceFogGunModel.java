...
public class DeviceFogGunModel {
	...
	public String toString() {
		return "DeviceFogGunModel [uuid=" + uuid + ", companyuuid=" + companyuuid + ", prouuid=" + prouuid + ", name="
				...
				+ ", host=" + host + ", spraytype=" + spraytype + ", getUuid()=" + getUuid() + ", getCompanyuuid()="
				+ getCompanyuuid() + ", getProuuid()=" + getProuuid() + ", getName()=" + getName()
				+ ", getEquipmentno()=" + getEquipmentno() + ", getPositionx()=" + getPositionx() + ", getPositiony()="
				+ getPositiony() + ", getSuppliercompanyuuid()=" + getSuppliercompanyuuid() + ", getAgentcompanyuuid()="
				+ getAgentcompanyuuid() + ", getIpaddressport()=" + getIpaddressport() + ", getIpportissuestatus()="
				+ getIpportissuestatus() + ", getWorktype()=" + getWorktype() + ", getLng()=" + getLng() + ", getLat()="
				+ getLat() + ", getPersonincharge()=" + getPersonincharge() + ", getPersoninchargephone()="
				+ getPersoninchargephone() + ", getInstallperson()=" + getInstallperson() + ", getInstallpersonphone()="
				+ getInstallpersonphone() + ", getReceipt()=" + getReceipt() + ", getInstalltime()=" + getInstalltime()
				+ ", getHost()=" + getHost() + ", getSpraytype()=" + getSpraytype() + ", getClass()=" + getClass()
